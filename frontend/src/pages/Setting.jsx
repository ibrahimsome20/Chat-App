...
function Setting() {
  ...
  // keep the form in sync once the user is loaded
  useEffect(() => {
  ...
  const avatarSrc = preview || user?.avatar || imageChat;
  ...
  return (
    <SideBarChat>
      <div className="flex-1 w-full max-w-5xl mx-auto p-6 bg-[#0b1220] text-cyan-100">
        ...
        <form
          onSubmit={handleSave}
          className="max-w-xl mx-auto bg-[#101A2E] rounded-xl p-6
        ...
        >
          ...
          <div className="flex flex-col items-center mb-6 relative">
            ...
            {isUpdateProfilePic && (
              <span className="text-xs text-cyan-300 mt-2">Uploading...</span>
            )}
          </div>
